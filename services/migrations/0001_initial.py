    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_parent', models.BooleanField(default=False, verbose_name='is a parent category')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='services.CategoryModel')),
            ],
        ),
        migrations.CreateModel(
            name='JobModel',
            fields=[
                ...
                ('status', models.CharField(choices=[('NT', 'Not Taken'), ('T', 'Taken'), ('COM', 'Completed')], default='NT', max_length=3)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ManyToManyField(blank=True, related_name='job', to='services.CategoryModel')),
                ('freelancer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ServiceModel',
            fields=[
                ...
                ('delivery_time', models.CharField(choices=[('Early', '1-3'), ('Normal', '3-5'), ('Later', '7+')], default='Normal', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('purchases', models.PositiveIntegerField(default=0)),
                ('portfolio_link', models.URLField(blank=True, null=True)),
                ('category', models.ManyToManyField(blank=True, related_name='service', to='services.CategoryModel')),
