...
urlpatterns = [
    ...
    #  path('job/<job_pk>/categories/', views.ServiceCategoryListAPIView.as_view(), name='job-category-list-api'),
    # path('job/<job_pk>/remove/<category_pk>/', views.RemoveCategoryAPIView.as_view(), name='remove-job-category-api-view'),
    #  path('job/<job_pk>/add/<category_pk>/', views.AddCategoryAPIView.as_view(), name='add-job-category-api-view'),
