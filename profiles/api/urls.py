...
urlpatterns = [
    ...
    path('skill/<pk>/', views.SkillDetailAPIView.as_view(), name='skill-detail-api'),
  #  path('links/', views.LinkListAPIView.as_view(), name='link-list-api'),
   ...
   # path('<user__username/')
    ...
    path('education/create/', views.EducationCreateAPIView.as_view(), name='education-create-api'),
