...
from services.models import ServiceModel, JobModel
...
class ServiceOrderModel(OrderModel):
    service = models.ForeignKey(ServiceModel, null=True, blank=True, on_delete=models.SET_NULL)
    job = models.ForeignKey(JobModel, null=True, blank=True, on_delete=models.SET_NULL)
...
class ComplaintModel(models.Model):
    ...
    order = models.OneToOneField(ServiceOrderModel, blank=False, null=False, on_delete=models.CASCADE)
...
# KEEPING THIS CODE FOR STANDARD ECOMMERCE
...
#     )
    ...
    # order = models.OneToOneField(ServiceOrderModel, null=True, blank=True, on_delete=models.CASCADE)
