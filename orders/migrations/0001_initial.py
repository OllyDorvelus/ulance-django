    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ManyToManyField(related_name='services', to='services.ServiceModel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ORD', 'Ordered'), ('INP', 'In Progress'), ('INC', 'Incomplete'), ('REF', 'Refunded'), ('COM', 'Complete')], max_length=3)),
                ...
                ('service', models.ManyToManyField(related_name='buyers', to='services.ServiceModel')),
            ],
            options={
                'abstract': False,
            },
